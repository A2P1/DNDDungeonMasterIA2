from agentes.HolaMundoLangchain import narrador # Importamos la función narrador del archivo HolaMundoLangchain.py para poder utilizarla en el orquestador
